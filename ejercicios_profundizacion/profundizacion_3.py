...
print(nombre_completo.lower())       # lower = todo en minuscula
print(nombre_completo.upper())       # upper = todo en mayuscula
print(nombre_completo.capitalize())  # capitalize = Primera letra en mayuscula
